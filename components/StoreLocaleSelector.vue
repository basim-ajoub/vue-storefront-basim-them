...
.container {
  ...
  .sf-bottom-modal {
  // Start change code to make language window small



  // End change code to make language window small
    z-index: 2;
    left: 0;
    @include for-desktop {
  ...
  //Start create motion for close the language window
  .sf-list-close{
    left:-50rem;
  }
  //End create motion for close the language window
