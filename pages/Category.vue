<template>
 ...
 <div class="main-container section">
      ...
      <div :class="{ loading }">
        <!--Start Change Add Customize Component-->
          <LazyHydrate class="offer-main-container" when-idle>
              <BasemComp class="basem-comp-offer desktop-only"  />
          </LazyHydrate>
    <!--End Change Add Customize Component-->
...
#category {
  ...
  //Start Change Color of Background
  background: white;
  border-radius: 1%;
...
.main-container {
    //display: flex;
  //Start Change Caegory Form Style
  background: var(--c-white);
  display:flex;
  width: 100%;

  //End Change Caegory Form Style
  ...
  &.section {
    ...
    @include for-desktop {
      padding: 0;
   //Start Change Caegory Form Style
      padding-bottom:var(--main-container-padding-bottom-- ,var(--spacer-2xl));
...
.products__product-card{
  &:hover{
    border-top: 2px solid var(--_c-braun-primary);
...
.sidebar {
  ...
  border-width: 0 1px 0 0;
  //Start Sidbar Change
 //background: var(--_c-braun-secondary);
 //width:10rem;
  //End Sidebar Change
}
.loading {
